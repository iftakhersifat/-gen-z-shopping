      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-8">
        ...
        <div className='md:w-1/2 flex flex-col justify-between'>
          <div>
            ...
            <p className='text-gray-600 mb-6 flex items-center gap-1'><FaStar className='text-amber-500' />{product.rating.rate}</p>
            <p className='text-2xl font-semibold text-gray-800 mb-6'>${product.price}
            </p>
          </div>

          <div className='flex flex-col gap-4'>
            <Link to={`/orders/new?productId=${product.id}`} className="btn bg-linear-to-r from-red-500 to-red-700 text-white rounded-2xl">Order Now</Link>
